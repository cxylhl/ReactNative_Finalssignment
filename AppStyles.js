...
const styles=StyleSheet.create({
    ...
    btn:{width:'35%',height:30,backgroundColor:'#3498db',borderRadius:20,color:'#f39c12',justifyContent:'center'},
    ...
    pokemonImg:{alignItems: 'center',justifyContent:"center",width:'80%'}
  })
